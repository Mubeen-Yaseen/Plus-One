    ...
    <>
      <div className='relative w-full h-[524px] bg-[#FFFFFF]'>
        <div className='w-[900px] h-[454px] relative mx-auto bg-[#F9FAFC]'>
          <h1 className="font-poppins font-medium text-[56px] leading-[61.6px] text-center">
            How it works
          </h1>

          <div className="flex gap-12 absolute left-1/2 transform -translate-x-1/2 w-[1040px] top-[134px] z-10">
            {/* First Box - No Rectangle */}
            <div className="w-[350px] h-[230px] pt-[30px] pl-[30px] pb-[30px] bg-white rounded-[16px] shadow-lg">
            ...
            {/* Second Box - Rectangle Positioned Slightly Outside */}
            <div className="relative w-[350px] h-[230px] p-[30px] bg-white rounded-[16px] shadow-lg overflow-visible">
              ...
              {/* Rectangle positioned slightly outside bottom-left */}
              <img 
                src={Rectangle}  alt="" className="absolute -bottom-5 -left-5 w-[90px] h-[90px] z-[-1]" />
            </div>

            {/* Third Box */}
            <div className="w-[350px] h-[230px] p-[30px] bg-white rounded-[16px] shadow-lg">
